...
[Gardener provides out-of-the-box logging and monitoring](https://github.com/gardener/gardener/blob/master/docs/extensions/logging-and-monitoring.md) for the Shoot control plane via a stack based on prometheus, loki and grafana.
